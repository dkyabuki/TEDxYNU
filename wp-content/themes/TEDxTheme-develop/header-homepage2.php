...
<script>(function (d, s, id) {
  ...
  <div class="nxt-event-background" id="next-event">
		<!--img id="nxt-event-img" src="/wordpress/wp-content/uploads/2017/12/Breathe-the-future-event-info.jpg"/-->
		<div class="black-block-container first">
		<div class="black-block"><div class="next-event-big-title">Breathe</div></div>
		</div>
		<div class="black-block-container">
		<div class="black-block"><div class="next-event-big-title">the Future</div></div>
		</div>
		<div class="black-block-container">
		<div class="black-block"><div class="next-event-small-title">July 11th, 2018</div></div>
		</div>
		<div class="black-block-container">
		<div class="black-block"><div class="next-event-small-title">Yokohama National University</div></div>
		</div>
		<div class="black-block-container last">
		<div class="black-block"><div class="next-event-logo"></div></div>
		</div>
	</div>
  <!-- .black-bg -->
  <!--div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bannerImage">
    <img src="wp-content/uploads/2017/12/image.png" alt="banner"/>
  </div-->
